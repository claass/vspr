      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-12 px-6">
        <header className="flex flex-col gap-4 text-center">
          ...
          <p className="text-arcana-text-low">
            Preview the resin, candle, chalice, tarot, and guidance components in one place. Toggle
            low-power via the root .low-power class.
          </p>
        </header>
...
export const Route = new Route({
  ...
  path: '/luminous-arcana',
  component: LuminousArcanaPage,
})
