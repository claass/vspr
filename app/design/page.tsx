...
const filaments: Filament[] = [
  {
    ...
    description: "We summarize your request and surface the key symbols guiding the response.",
...
export default function DesignGallery() {
  ...
  return (
    <>
      <div className={`noise-overlay ${noiseEnabled ? "is-active" : ""}`} aria-hidden="true" />
